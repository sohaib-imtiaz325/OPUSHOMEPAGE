...
import MiniAboutUs from "../Ref-Home/MiniAboutUs";
...
const AboutUs = () => {
  return (
    ...
    <MiniAboutUs/>
      ...
      {/* ✅ Visible only on laptops/desktops */}
      <div className="hidden md:flex min-h-screen w-full bg-white font-manrope flex-col md:flex-row justify-center items-start overflow-hidden px-6 lg:px-16 py-20">
        {/* LEFT SIDE */}
        <div className="flex-1 flex flex-col items-start justify-start space-y-10">
          ...
          <div className="max-w-lg h-[450px]">
            ...
            <p className="text-[15px] text-gray-700 leading-relaxed">
              ...
              visibility for brands. By streamlining the media buying process,
              we help advertisers efficiently reach their target audience
              without the hassle of direct negotiations.
            </p>
          </div>
